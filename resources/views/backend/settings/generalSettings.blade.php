                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-body">
                            ...
                            <!--end:::Tabs-->
                            <!--begin::Form-->
                            <form action="{{ route('setting.general.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <!--begin:::Tab content-->
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="kt_ecommerce_settings_general"
                                        ...
                                        <div class="row fv-row mb-7">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="image-input image-input-outline" data-kt-image-input="true"
                                                    style="background-image: url('assets/backend/images/no_image.png')">
                                                    <!--begin::Preview existing avatar-->
                                                    <div class="image-input-wrapper w-125px h-125px"
                                                        style="background-image: url('{{ !empty(settings('header_logo')) ? asset('storage/' . settings('header_logo')) : url('assets/backend/images/no_image.png') }}')">
                                                    </div>
                                        ...
                                        <div class="row fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="col-lg-4 col-form-label fw-semibold fs-6">Footer logo</label>
                                            <!--end::Label-->
                                            <!--begin::Col-->
                                            <div class="col-lg-8">
                                                <!--begin::Image input-->
                                                <div class="image-input image-input-outline" data-kt-image-input="true"
                                                    ...
                                                    <!--begin::Preview existing avatar-->
                                                    <div class="image-input-wrapper w-125px h-125px"
                                                        style="background-image: url('{{ !empty(settings('footer_logo')) ? asset('storage/' . settings('footer_logo')) : url('assets/backend/images/no_image.png') }}')">
                                                    </div>
                                                    <!--end::Preview existing avatar-->
                                                    <!--begin::Label-->
                                                    <label
                                        ...
                                        <div class="row fv-row mb-7">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="image-input image-input-outline" data-kt-image-input="true"
                                                    ...
                                                    <!--begin::Preview existing avatar-->
                                                    <div class="image-input-wrapper w-125px h-125px"
                                                        style="background-image: url('{{ !empty(settings('favicon')) ? asset('storage/' . settings('favicon')) : url('assets/backend/images/no_image.png') }}')">
                                                    </div>
                                                    <!--end::Preview existing avatar-->
                                                    <!--begin::Label-->
                                                    <label
                                        ...
                                        <div class="row fv-row mb-7">
                                            <div class="col-md-3 text-md-end">
                                                <!--begin::Label-->
                                                <label class="fs-6 fw-semibold form-label mt-3">
                                                    <span class="required">Application Email</span>
                                                    <span class="ms-1" data-bs-toggle="tooltip"
                                                        title="Set Application email.">
                                                        <i class="ki-duotone ki-information-5 text-gray-500 fs-6">
                                                            <span class="path1"></span>
                                                            <span class="path2"></span>
                                                            <span class="path3"></span>
                                        ...
                                        <div class="row fv-row mb-7">
                                            <div class="col-md-3 text-md-end">
                                                <!--begin::Label-->
                                                <label class="fs-6 fw-semibold form-label mt-3">
                                                    <span class="required">Application Phone</span>
                                                    <span class="ms-1" data-bs-toggle="tooltip"
                                                        title="Set Application phone number.">
                                                        <i class="ki-duotone ki-information-5 text-gray-500 fs-6">
                                                            <span class="path1"></span>
                                                            <span class="path2"></span>
                                                            <span class="path3"></span>
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <input type="number" class="form-control form-control-solid"
                                                    ...
                                                    value="{{ settings('application_phone')}}" />
                                                <!--end::Input-->
                                            </div>
                                        </div>
                                        <!--end::Input group-->
